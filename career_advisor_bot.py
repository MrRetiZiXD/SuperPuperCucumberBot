...
#  KODLAND был и остаётся местом, где я вырос как разработчик. 
#  Мой последний курс стал логичным завершением — много практики, полезных знакомых и уверенности в будущем. Спасибо за этот путь!
